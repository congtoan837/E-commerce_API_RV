...
public class ProductController {
    ...
    public ApiResponse<PageResponse<ProductResponse>> getAllProduct(
        ...
        return ApiResponse.<PageResponse<ProductResponse>>builder()
                .result(productService.get(keyword, page, size))
                .build();
    }

    @GetMapping("/getDetail")
    public ApiResponse<ProductResponse> getDetailProduct(@RequestParam UUID productId) {
        return ApiResponse.<ProductResponse>builder()
                .result(productService.getDetail(productId))
                .build();
    }
    ...
    public ApiResponse<Boolean> deleteProduct(@PathVariable @Valid UUID productId) {
